...
public class GameManager : MonoBehaviour
{
    ...
    public void LinkHealPlayerEvent(Action<HealPlayerEventData> action) { eventBus.HealPlayerEvent.Unregister(action); }
    ...
    public void LinkDamagePlayerEvent(Action<DamagePlayerEventData> action) { eventBus.DamagePlayerEvent.Unregister(action); }
    ...
    public void LinkEnemyDeathEvent(Action<EnemyDeathEventData> action) { eventBus.EnemyDeathEvent.Unregister(action); }
    ...
    #region GetItemEvent
    public void LinkGetItemEvent(Action<GetItemEventData> action) { eventBus.GetItemEvent.Unregister(action); }
    ...
    public void LinkUpdateStatsEvent(Action<UpdateStatsEventData> action) { eventBus.UpdateStatsEvent.Unregister(action); }
    ...
    public void LinkEquipWeaponEvent(Action<EquipWeaponEventData> action) { eventBus.EquipWeaponEvent.Unregister(action); }
    ...
    public void LinkGainManaEvent(Action<GainManaEventData> action) { eventBus.GainManaEvent.Unregister(action); }
    ...
    public void LinkLoseManaEvent(Action<LoseManaEventData> action) { eventBus.LoseManaEvent.Unregister(action); }
